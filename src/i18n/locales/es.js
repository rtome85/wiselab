export const es = {
  app: {
    ...
    aiTutor: 'Tutor de IA',
    heroTitle1: 'Aprende cualquier cosa',
    heroTitle2: 'Paso a paso',
    heroDesc: 'Pega el problema o haz una foto. WiseLab lo convierte en una lección guiada con comprobaciones de comprensión.',
  ...
  input: {
    placeholder: 'Escribe tu pregunta, pega la tarea o describe lo que quieres que te expliquen',
    usePhoto: 'Usar foto',
