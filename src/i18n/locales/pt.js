export const pt = {
  app: {
    ...
    aiTutor: 'Tutor de IA',
    heroTitle1: 'Aprende tudo',
    heroTitle2: 'Passo a passo',
    heroDesc: 'Cola o problema ou tira uma foto. O WiseLab transforma-o numa lição guiada com verificações de compreensão.',
  ...
  input: {
    placeholder: 'Escreve a tua pergunta, cola o trabalho de casa ou descreve o que queres que te expliquem',
    usePhoto: 'Usar foto',
  ...
  lesson: {
    ...
    goToStep: 'Voltar ao passo {number}: {title}',
  },
  finalAnswer: {
