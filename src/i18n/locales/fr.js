export const fr = {
  app: {
    ...
    aiTutor: 'Tuteur IA',
    heroTitle1: "Apprenez n'importe quoi",
    heroTitle2: 'Étape par étape',
    heroDesc: "Collez le problème ou prenez une photo. WiseLab le transforme en leçon guidée avec des vérifications de compréhension.",
  ...
  settings: {
    ...
    getApiKey: 'Obtenez votre clé API sur {link}',
  ...
  input: {
    placeholder: "Tapez votre question, collez un devoir ou décrivez ce que vous voulez qu'on vous explique",
  ...
  lesson: {
    ...
    goToStep: 'Retour à l\'étape {number} : {title}',
  },
  finalAnswer: {
